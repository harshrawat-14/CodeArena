...
const Header = ({ user, onLogout }) => {
  ...
  return (
    <header className="relative z-50 bg-white/95 glass-morphism backdrop-blur-xl shadow-2xl border-b border-white/20">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex space-x-2" data-aos="fade-down" data-aos-delay="200">
              <Link to="/ide" className="group relative px-4 py-2 text-gray-700 hover:text-blue-600 font-medium transition-all duration-300 rounded-lg hover:bg-blue-50/50">
              ...
              <Link to="/leaderboard" className="group relative px-4 py-2 text-gray-700 hover:text-purple-600 font-medium transition-all duration-300 rounded-lg hover:bg-purple-50/50">
              ...
              <Link to="/customContest" className="group relative px-4 py-2 text-gray-700 hover:text-pink-600 font-medium transition-all duration-300 rounded-lg hover:bg-pink-50/50">
          ...
          <div className="flex items-center space-x-6" data-aos="fade-left" data-aos-delay="300">
            ...
            {user ? (
              <>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="group flex items-center space-x-3 text-sm bg-white/50 glass-morphism rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-500/30 premium-shadow hover:shadow-2xl transition-all duration-500 p-2 mr-3"
                    title="View Profile"
                  >
                <div className="flex items-center space-x-3 px-2 py-1">
                  ...
                  <div className="hidden sm:block text-left">
                    <p className="text-sm font-semibold text-gray-900">{user?.username || user?.name || 'Guest'}</p>
              ...
              <button
                ...
                className="group p-2 text-gray-400 hover:text-blue-600 transition-all duration-300 rounded-lg hover:bg-blue-50/50"
              >
              ...
              {isMenuOpen && (
                <div className="absolute right-0 mt-3 w-72 bg-white/95 glass-morphism backdrop-blur-xl rounded-2xl shadow-2xl premium-shadow border border-white/20 z-[9999] overflow-hidden animate-fadeIn">
                  <div className="py-2">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link 
                  to="/signup"
                  className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Sign Up
                </Link>
              </div>
