...
int main() {
  ...
  const handleRunCode = useCallback(async () => {
    ...
    const headers = {};
    // Note: If you need auth tokens for backend API calls, you can get them from Firebase auth
  ...
  useEffect(() => {
    const handleKeyDown = (event) => {
      ...
      // Ctrl + S: Save Code (you can implement this as needed)
      if (event.ctrlKey && event.key === 's') {
        event.preventDefault();
        // Add save functionality here if needed
        console.log('Code saved (implement save functionality)');
      }
    };
  ...
  }, [handleRunCode, handleAiReview]); // Dependencies for the keyboard shortcuts
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        {/* IDE Header */}
        <div className="relative bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 text-white py-8 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold gradient-text animate-pulse font-display">
                🖥️ Advanced IDE
              </h1>
              <p className="text-xl text-blue-100 text-shadow font-light mt-2">
                Complete coding environment with AI assistance
              </p>
            </div>
          </div>
        </div>
        ...
        <main className="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {/* Right Column - Output and AI Review */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white/95 glass-morphism rounded-xl p-6 text-center border border-white/20">
